      ...
      <div className="card">
        ...
        <div className="card-buttons">
          <div className="card-button-wrapper card-button-wrapper-secondary">
            <button className="card-button card-button-secondary" onClick={onTweakThis}>Tweak This</button>
          </div>
          <div className="card-button-wrapper card-button-wrapper-primary">
            <button className="card-button card-button-primary" onClick={onDoThis}>Let's Do This</button>
          </div>
        </div>
      </div>
    </div>
